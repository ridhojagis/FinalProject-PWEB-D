...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$stmt = $conn->prepare('INSERT INTO guru (guru_nama, guru_email, guru_password) VALUES (?, ?, ?)');
		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title text-center">REGISTER GURU</h4>
							<form method="POST" class="my-login-validation" novalidate="">
								...
								<div class="mt-4 text-center">
									Already have an account? <a href="login-guru.php">Login</a>
								</div>
							</form>
						</div>
					</div>
