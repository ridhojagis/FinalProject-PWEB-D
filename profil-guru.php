<?php
session_start();
if(!isset($_SESSION['email']) || (isset($_SESSION['user_type']) && $_SESSION['user_type'] != 'guru')){
  header("location:login-guru.php");
}
include_once("database/db_connection.php");
$email = $_SESSION['email'];
 
$query = "SELECT * FROM guru WHERE guru_email='$email'";
$grdata = mysqli_fetch_assoc(mysqli_query($conn, $query));
$id = $grdata['guru_id'];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(true) {
	    $name = (isset($_POST['name'])) ? $_POST['name'] : $grdata['guru_name'];
        $email = (isset($_POST['email'])) ? $_POST['email'] : $grdata;
        ...
        $query = "UPDATE guru
                    ...
                    guru_alamat = ".$address.",
                    guru_kontak = ".$tel.",
                    guru_tempatlahir = ".$pob.",
                    guru_jkel = ".$sex.",
                    guru_tanggallahir = ".$dob."
                    WHERE guru_id = $id";
        // echo $query;
    ...
    <header id="header" class="fixed-top d-flex " style="background-color: rgba(5, 87, 158, 0.9);">
        <div class="container d-flex align-items-center ">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              <li><a class="nav-link scrollto" href="dashboard-guru.php">Dashboard</a></li>
              <li>
            <div class="dropdown">
    ...
    <div class="col-md-4">      
        <div class="portlet light profile-sidebar-portlet bordered">
            ...
            <div class="profile-usertitle">
                <div class="profile-usertitle-name"> <?php echo $grdata['guru_nama']?> </div>
            </div>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title tabbable-line">
                <div class="caption caption-md" id="profil">
                    ...
                    <span class="caption-subject font-blue-madison bold uppercase">Profil Guru</span>
                </div>
            </div>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="Home">
                            <form action="" method="POST">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control profile" id="inputName" name="name" value="<?php echo $grdata['guru_nama']?>" disabled readonly>
                              </div>
                              <div class="form-group">
                                <label for="exampleInputEmail1">Email</label>
                                <input type="email" class="form-control profile" id="InputEmail" name="email" value="<?php echo $grdata['guru_email']?>" disabled readonly>
                              </div>
                              <div class="form-group">
                                <label for="exampleInputEmail1">No. HP</label>
                                <input type="text" class="form-control profile" id="InputNo" name="tel" pattern="[0-9]{11}" value="<?php echo $grdata['guru_kontak']?>" disabled readonly>
                              </div>
                              <div class="form-group">
                                <label for="exampleInputEmail1">Alamat</label>
                                <input type="text" class="form-control profile" id="InputAlamat" name="address" value="<?php echo $grdata['guru_alamat']?>" disabled readonly>
                              </div>
                              <div class="form-group">
                                <label for="exampleInputEmail1">Jenis Kelamin (L/P)</label>
                                <input type="text" class="form-control profile" id="InputJenisKel" name="sex" value="<?php echo $grdata['guru_jkel']?>" disabled readonly>
                              </div>
                              <div class="form-group">
                                <label for="exampleInputEmail1">Tempat Lahir</label>
                                <input type="text" class="form-control profile" id="InputTempatlahir" name="pob" value="<?php echo $grdata['guru_tempatlahir']?>" disabled readonly>
                              </div>
                              <div class="form-group">
                                <label for="exampleInputEmail1">Tanggal Lahir (yyyy-mm-dd)</label>
                                <input type="text" class="form-control profile" id="InputTgllahir" name="dob" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" value="<?php echo $grdata['guru_tanggallahir']?>" disabled readonly>
                              </div>
